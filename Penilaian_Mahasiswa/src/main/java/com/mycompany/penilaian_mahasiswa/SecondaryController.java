...
public class SecondaryController implements Initializable {
    ...
    // Deklarasi TableColumn untuk TableView
    @FXML
    ...
    // Deklarasi TextField untuk input data mahasiswa
    @FXML
    ...
    // Fungsi untuk menginisialisasi TableView dan menghubungkan kolom
    @Override
    public void initialize(URL location, ResourceBundle resources) {
        // Mengonfigurasi kolom TableView
        ...
        // Memuat data mahasiswa jika ada dari database
        loadDataMahasiswa();
    }

    // Fungsi untuk menyimpan mahasiswa ke dalam database
    @FXML
    ...
    private boolean saveMahasiswaToDatabase(Mahasiswa mahasiswa) {
        try (Connection connection = KoneksiDB.getConnection()) {
            ...
            try (PreparedStatement pst = connection.prepareStatement(query)) {
                ...
                return result > 0;  // Mengembalikan true jika data berhasil disimpan
            }
    ...
    // Fungsi untuk memuat data mahasiswa dari database dan menambahkannya ke TableView
    private void loadDataMahasiswa() {
        try (Connection connection = KoneksiDB.getConnection()) {
            String query = "SELECT * FROM mahasiswa";  // Query untuk mengambil data mahasiswa
            try (PreparedStatement pst = connection.prepareStatement(query);
                ...
                while (rs.next()) {
                    ...
                    // Membuat objek Mahasiswa dan menambahkannya ke TableView
                    Mahasiswa mahasiswa = new Mahasiswa(nama, npm, jurusan, angkatan, prodi);
